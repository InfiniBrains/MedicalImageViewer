...
namespace Dicom.Network
{
    ...
    public class UnityNetworkListener : INetworkListener
    {
        ...
        public Task<INetworkStream> AcceptNetworkStreamAsync(string certificateName, bool noDelay, CancellationToken token)
        {
            return Task.Run(() => AcceptNetworkStream(certificateName,noDelay));throw new System.NotImplementedException();
        }
