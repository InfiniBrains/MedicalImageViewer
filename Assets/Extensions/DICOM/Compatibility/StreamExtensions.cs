...
namespace System.IO
{
    ...
    public static class StreamExtensions
    {
        ...
        {
            if (source == null) throw new ArgumentNullException(TestExtension.nameof(()=>source));
            if (destination == null) throw new ArgumentNullException(TestExtension.nameof(()=>destination));
