...
namespace Dicom.Imaging.Render
{
    ...
    public class GrayscalePixelDataU8 : IPixelData
    {
        ...
        {
            if (channel != 0) throw new ArgumentOutOfRangeException(TestExtension.nameof(()=>channel), channel, "Expected channel 0 for grayscale image.");
