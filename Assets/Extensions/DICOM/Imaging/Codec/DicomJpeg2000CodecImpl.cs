            ...
            DicomJpeg2000Params parameters)
        {
            ...
            for (var frame = 0; frame < oldPixelData.NumberOfFrames; frame++)
            {
                ...
                for (var c = 0; c < nc; c++)
                {
                    ...
                    {
                        throw new InvalidOperationException( "JPEG 2000 codec does not support Bits Allocated == "+oldPixelData.BitsAllocated);
                    }
            ...
            DicomJpeg2000Params parameters)
        {
            ...
            for (var frame = 0; frame < oldPixelData.NumberOfFrames; frame++)
            {
                ...
                for (var c = 0; c < image.NumberOfComponents; c++)
                {
                    ...
                    {
                        throw new InvalidOperationException("JPEG 2000 codec does not support Bits Allocated == "+newPixelData.BitsAllocated+"!");
                    }
                }
