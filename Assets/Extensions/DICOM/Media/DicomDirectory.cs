...
namespace Dicom.Media
{
    ...
    public class DicomDirectory : DicomFile
    {
        ...
        /// </summary>
		public DicomDirectoryRecordCollection RootDirectoryRecordCollection {get { return new DicomDirectoryRecordCollection(this.RootDirectoryRecord);}}
        ...
        public static new DicomDirectory Open(string fileName, Encoding fallbackEncoding, Func<ParseState, bool> stop = null)
        {
            ...
            {
                throw new ArgumentNullException(TestExtension.nameof(()=>fallbackEncoding));
            }
        ...
        {
            if (dicomFile == null) throw new ArgumentNullException(TestExtension.nameof(()=>dicomFile));
        ...
        {
            if (recordType == null) throw new ArgumentNullException(TestExtension.nameof(()=>recordType));
            if (dataset == null) throw new ArgumentNullException(TestExtension.nameof(()=>dataset));
